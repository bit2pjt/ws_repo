...
<style>
	<!-- /*board/free/get : 1. 글본문*/ -->
	<!-- /*board/free/get : 1-1. 글제목*/ -->
	.ws-post-get-title {
		padding:10px;margin:10px 0px;background-color:#FFDBD8;position:relative;bottom:5px;
	}
	<!-- /*board/free/get : 1-2. 글쓴이 정보*/ -->
	.ws-post-get-info {
	border-width:3px 0px;border-style:solid;border-color:#0F2133;
	}
	.ws-post-get-info span {
	display:inline-block;
	}
	.ws-post-get-info img {
	width:150px;margin:10px;border-color:#525EAA;
	}
	
	<!-- /*board/free/get : 1-3. 글본문*/ -->
	.ws-post-get-content {
	min-height:200px;height:100%;padding:10px;
	}
	
	.ws-reply-buffer {
	height:40px;
	}
	<!-- /*board/free/get : 댓글간격 및 바탕색*/ -->
	.ws-reply-outer {
	background-color:#ffffff;margin:5px;
	}
	<!-- /*board/free/get : 댓글 상하단의 얇은 구분선*/ -->
	.ws-reply-outer .author-infor {
	...
	<!-- /*board/free/get : 기타. 버튼들 ??*/ -->
	.ws-btn-warning {
	min-width:35px;min-height:35px;background-color:#ffffff;border-radius:8px;border:1px solid #FF6F61;right:5px;margin:5px;color:orange;
	}
	.ws-btn-thumbs-up {
	min-width:50px;min-height:35px;background-color:#ffffff;border-radius:8px;border:1px solid #FF6F61;right:5px;margin:5px;color:blue;
	}
	.ws-btn-thumbs-down {
	min-width:50px;min-height:35px;background-color:#ffffff;border-radius:8px;border:1px solid #FF6F61;right:5px;margin:5px;color:red;
	}
	.ws-btn-update {
	width:35px;height:35px;background-color:#ffffff;border-radius:8px;border:1px solid #FF6F61;position:relative;right:5px;margin:5px;
	}
	.ws-btn-delete {
	width:35px;height:35px;background-color:#ffffff;border-radius:8px;border:1px solid #99098f;position:relative;right:5px;margin:5px;
	}
