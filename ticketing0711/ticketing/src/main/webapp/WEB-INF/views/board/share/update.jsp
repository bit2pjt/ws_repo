...
<style>
	<!--/* board/free/write의 설정을 그대로 따른다 */-->
	<!--/*board/free/write : 1. 글쓰기 컨테이너 설정 */-->
	.ws-writer-box {
		padding:75;
	}
	.ws-top-writer {
	...
	<!--/*board/free/write : 2. 글쓰기 상단부의 밑줄 설정 */-->
	.ws-top-writer input {
		width:75%;border-color:#999999; background-color:#FFFFFF; border-style:solid;
       	border-top-width:0px; border-bottom-width:1px; border-left-width:0px;
       	border-right-width:0px;color:#0000FF;
	}
	<!--/*board/free/write : 3. 글쓰기 공지 부분의 설정 */-->
	.ws-middle-top-writer {
		border:1px solid;width:100%;height:80;background-color:#f8f87d;
	}
...
<div class="buster-light" style="min-height:1300px;">
	...
	<form>
		...
		<br>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="radio" name="category"> <label>티켓나눔&nbsp;&nbsp;&nbsp;</label>
		<input type="radio" name="category"> <label>스낵나눔&nbsp;&nbsp;&nbsp;</label>
		</div>
...
<%@include file="../../includes/footer_bs_write.jsp" %>
